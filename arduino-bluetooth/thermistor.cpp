...
int THERMISTOR::read(void)
{
  ...
  Serial.print("Hello Dee 2:  Average analog reading "); 
  ...
  #ifdef VERBOSE_SENSOR_ENABLED
  Serial.print("Hello Dee 2:  Thermistor resistance "); 
  Serial.println(average);
  Serial.print("\nHello Dee 2:  serialResistance: "); 
  Serial.println(serialResistance);
  Serial.print("\nHello Dee 2:  bCoefficient: "); 
  ...
  #ifdef VERBOSE_SENSOR_ENABLED
  Serial.print("Hello Dee 2:  Temperature "); 
